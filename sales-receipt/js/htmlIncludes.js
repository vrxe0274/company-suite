...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    document.body.insertAdjacentHTML(
      "afterbegin",
      `<div class="load-error">Unable to load HTML partials. Please run this project using a local server such as VS Code Live Server or <code>python3 -m http.server</code>.</div>`
    );
  }
});
